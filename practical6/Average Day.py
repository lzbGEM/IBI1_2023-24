import matplotlib.pyplot as plt  # Import the 'pyplot' module from the 'matplotlib' library for plotting graphs.
...
plt.title('Pie Chart')   # Set the title for the pie chart.
plt.show()
plt.clf()
