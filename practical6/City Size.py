...
china_cities=[0.58,8.4,29.9,22.2]#store all the data into empty lists

uk_cities.sort()#ascending sort all the data
print(uk_cities)
china_cities.sort()
print(china_cities)
...
plt.bar(cities_name1,uk_cities,width=0.3,label='UK')#input x，y into bar chart
